...
const CONFIG: Record<string, StateConfig> = {
    ...
    kiralikArac: {
        icon: Car,
        title: "Henüz Kiralık Araç Kaydı Yok",
        description: "Kiralık araçları bu listeden ekleyip yönetebilirsiniz.",
        colorClass: "text-slate-600",
        bgClass: "bg-slate-50",
    },
    taseronArac: {
        icon: Car,
        title: "Henüz Taşeron Araç Kaydı Yok",
        description: "Taşeron araçları bu listeden ekleyip yönetebilirsiniz.",
        colorClass: "text-slate-600",
        bgClass: "bg-slate-50",
    },
    personel: {
    ...
    kiralikPersonel: {
        icon: Users,
        title: "Kiralık Personel Kaydı Bulunmuyor",
        description: "Kiralık personelleri buradan ayrı olarak yönetebilirsiniz.",
        colorClass: "text-slate-600",
        bgClass: "bg-slate-50",
    },
    taseronPersonel: {
        icon: Users,
        title: "Taşeron Personel Kaydı Bulunmuyor",
        description: "Taşeron personelleri buradan ayrı olarak yönetebilirsiniz.",
        colorClass: "text-slate-600",
        bgClass: "bg-slate-50",
    },
    zimmet: {
