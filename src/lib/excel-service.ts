...
export const EXCEL_MODEL_PROFILES: Record<string, ExcelModelProfile> = {
    ...
    arizaKaydi: {
        ...
        labels: {
            ...
            kazaTuru: "Kaza Türü",
            kazaYeri: "Kaza Yeri",
            sigortaDosyaNo: "Sigorta Dosya No",
            eksperNotu: "Eksper Notu",
            kusurOrani: "Kusur Oranı",
            aciklama: "Kaza Özeti",
            durum: "Onarım Durumu",
            servisAdi: "Onarım Merkezi",
            tutar: "Maliyet",
        },
        aliases: {
            kazaTarihi: ["Kaza Tarihi", "Kaza Zamanı", "Kaza Zamani"],
            kazaTuru: ["Kaza Türü", "Kaza Turu", "Hasar Türü", "Hasar Turu"],
            kazaYeri: ["Kaza Yeri", "Kaza Konumu", "Konum"],
            sigortaDosyaNo: ["Sigorta Dosya No", "Dosya No", "Hasar Dosya No"],
            eksperNotu: ["Eksper Notu", "Eksper Açıklaması", "Eksper Aciklamasi"],
            kusurOrani: ["Kusur Oranı", "Kusur Orani", "Kusur %", "Kusur"],
            arac: ["Araç", "Arac", "Plaka"],
            bildirenSofor: ["Şoför", "Sofor", "Bildiren"],
            aciklama: ["Kaza Özeti", "Kaza Açıklaması", "Kaza Aciklamasi", "Açıklama", "Aciklama"],
            durum: ["Durum", "Onarım Durumu", "Onarim Durumu"],
            servisAdi: ["Onarım Merkezi", "Onarim Merkezi", "Servis", "Servis Adı", "Servis Adi"],
            tutar: ["Maliyet", "Tutar", "Hasar Tutarı", "Hasar Tutari"],
        },
    },
    kullaniciZimmet: {
