...
export const columns: ColumnDef<KaskoRow>[] = [
    {
        accessorKey: "aktifMi",
        header: "Mevcut Durum",
        cell: ({ row }) => {
            ...
            if (!aktif) return <Badge className="bg-slate-100 text-slate-700 hover:bg-slate-200 border-0 shadow-none font-semibold px-2">Geçmiş Kasko</Badge>;

            if (kalanGun < 0) return <Badge className="bg-rose-100 text-rose-800 hover:bg-rose-200 border-0 shadow-none font-bold px-2">Kasko Süresi Doldu!</Badge>;
            ...
            return <Badge className="bg-emerald-100 text-emerald-800 hover:bg-emerald-200 border-0 shadow-none font-semibold px-2">Kasko Geçerli</Badge>;
        },
    },
    {
