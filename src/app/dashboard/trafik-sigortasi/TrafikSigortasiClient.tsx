...
import { Search, ShieldAlert, Shield, ChevronRight } from "lucide-react";
...
export default function TrafikSigortasiClient({ initialData }: { initialData: SigortaRow[] }) {
            ...
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-slate-900 flex items-center gap-2">
                        ...
                        Trafik Sigortası Poliçeleri
                    </h2>
                    <p className="text-slate-500 text-sm mt-1">Zorunlu trafik sigortası yenileme tarihleri ve poliçe detayları.</p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-[#E2E8F0] overflow-hidden">
                <div className="border-b border-[#E2E8F0] p-4 flex flex-col sm:flex-row gap-4 items-center justify-between bg-[#F8FAFC]">
                    <div className="relative w-full sm:w-80">
                        ...
                        <Input
                            type="text"
                            placeholder="Plaka veya şirket ara..."
                            ...
                            {filteredData.length > 0 ? (
                                ...
                                <TableRow>
                                    <TableCell colSpan={7} className="h-48 text-center text-slate-500">
                                        Seçili kriterlere uygun poliçe bulunamadı.
                                    </TableCell>
                                </TableRow>
                            )}
                        </TableBody>
